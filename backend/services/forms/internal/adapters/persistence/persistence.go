...
import (
	...
	"sundance/backend/services/forms/internal/adapters/persistence/inmemory"
	"sundance/backend/services/forms/internal/adapters/persistence/mongodb"
...
func bootstrapMongoDB(o PersistenceOptions, logger *slog.Logger) (*ports.Repository, error) {
	...
	return mongodb.Bootstrap(client, logger, options.DatabaseName)
}
